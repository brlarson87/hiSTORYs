    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollView}>
        ...
        <Pressable
          style={styles.story}
          onPress={() =>
            navigation.push("Full Story", {
              storyId: "BkCCpkfUdrH6iZ2IPXR3",
              title: "Attack on Pearl Harbor",
              collectionName: "United-States",
            })
          }
        >
          <View style={styles.titleAndDescription}>
            ...
            <Text style={styles.StoryDescription}>
              Detailed story on the Japanese attack on the United States naval
              base in Hawaii
            </Text>
        ...
        <Pressable
          style={styles.story}
          onPress={() =>
            navigation.navigate("Full Story", {
              storyId: "BkCCpkfUdrH6iZ2IPXR3",
              title: "Attack on Pearl Harbor",
              collectionName: "United-States",
            })
        ...
        <Pressable
          style={styles.story}
          onPress={() => navigation.push("Full Story")}
        >
          <View style={styles.titleAndDescription}>
            <Text style={styles.StoryTitle}>Pearl Harbor Attacks</Text>
            <Text style={styles.StoryDescription}>
