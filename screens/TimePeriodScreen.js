...
const TimePeriodScreen = ({ navigation, route }) => {
  // fetch unique time periods from "<CONTINENT NAME COLLECTION>" "<COUNTRY>" passed in the route.params"
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollView}>
        <Pressable
          ...
          onPress={() => navigation.push("Story Pick")}
        >
